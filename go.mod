module github.com/candlekeep/zot-artifact-store

go 1.25.3

require zotregistry.io/zot v1.4.3
...
require (
	...
	github.com/aquasecurity/trivy v0.0.0-00010101000000-000000000000 // indirect
	...
	github.com/notaryproject/notation-go v0.12.0-beta.1 // indirect
...
// Replace directives to fix dependency issues in Zot
replace (
